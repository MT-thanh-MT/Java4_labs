		...
		<section class="row">
					...
					<div class="col">
						<form action="RegisterServlet" method="post">
							...
							<div class="form-group">
								...
								<div class="form-check form-check-inline">
									<input type="checkbox" class="form-check form-check-input"
										name="favorites" id="Tourist" value="Tourist" />
										<label for="Tourist">Du Lịch</label>
								</div>
								<div class="form-check form-check-inline">
									<input type="checkbox" class="form-check form-check-input"
										name="favorites" id="others" value="others" />
										<label class="form-label" for="others">Khác</label>
								</div>
							</div>
							<div class="form-group">
			...
			<div class="col-5">
				...
				<ul>
					...
					<li>Tình trạng hôn nhân: ${ married ? 'Đã lập gia đình' : 'Chưa lập gia đình' }</li>
